    ...
    return (
        <div className="modal-container">
            ...
            <div className="modal-content">
                <label className="modal-close" htmlFor={`modal-toggle${cardNumber}`}>
          &#x2715;
                </label>
                <h2>{name}</h2>
                <hr />
            ...
            View Screenshots
                ...
                <label
                    ...
                    htmlFor={`modal-toggle${cardNumber}`}
                >
          OK
                </label>
            </div>
            <label className="modal-btn" htmlFor={`modal-toggle${cardNumber}`}>
